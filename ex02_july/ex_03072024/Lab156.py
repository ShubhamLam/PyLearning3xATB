# print("dads") #Identation error : unexpected indent
# result = 5 + "5" #TypeError: unsupported operand type(s) for +: 'int' and 'str'
# int("promod") # ValueError: invalid literal for int() with base 10: 'pramod'
# print(undefined_varibale) #NameError: name 'undefined_variable' is not defined
